...
const HOLES = {
  ...
  6:  { green: {x:104, y:68},  tees: { WHITE:{x:84, y:657}, YELLOW:{x:90, y:632}, BLUE:{x:97, y:575}, RED:{x:99, y:562} }, holeLength: 522, pixelLength: 600 },
  ...
  8:  { green: {x:158, y:65},  tees: { WHITE:{x:169,y:649}, YELLOW:{x:152,y:611}, BLUE:{x:138,y:573}, RED:{x:125,y:540} }, holeLength: 367, pixelLength: 600 },
  ...
  12: { green: {x:72,  y:62},  tees: { WHITE:{x:61, y:643}, YELLOW:{x:93, y:604}, BLUE:{x:111,y:575}, RED:{x:101,y:503} }, holeLength: 362, pixelLength: 600 },
  13: { green: {x:61,  y:77},  tees: { WHITE:{x:54, y:637}, YELLOW:{x:67, y:612}, BLUE:{x:96, y:556}, RED:{x:104,y:542} }, holeLength: 399, pixelLength: 593 },
  14: { green: {x:154, y:80},  tees: { WHITE:{x:170,y:624}, YELLOW:{x:158,y:596}, BLUE:{x:138,y:553}, RED:{x:125,y:528} }, holeLength: 398, pixelLength: 569 },
  ...
  17: { green: {x:163, y:68},  tees: { WHITE:{x:89, y:646}, YELLOW:{x:80, y:601}, BLUE:{x:78, y:578}, RED:{x:72, y:536} }, holeLength: 427, pixelLength: 595 },
  18: { green: {x:64,  y:69},  tees: { WHITE:{x:80, y:661}, YELLOW:{x:98, y:607}, BLUE:{x:100,y:585}, RED:{x:120,y:548} }, holeLength: 561, pixelLength: 601 },
};
...
function loadHole(n) {
  ...
  bgImage.src = `holes/loch${n}.png?v=12`;
  updateHoleInfo();
  redraw();
}
